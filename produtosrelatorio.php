...
<div class="content">
   <form><input type="button" value="Gerar PDF" onclick="getPDF()"></form>
			...
			<table id="myTable">
<tr><th>Id</th><th onclick="sortTable(1)">Nome</th><th>Estoque</th><th>Descrição</th><th>Valor</th></tr>
				
	<?php
	  while($row = $result->fetch_assoc()) {
		echo "<tr><td>" . $row["id_produto"] . "</td><td>" . $row["nome"] . "</td><td>" . $row["estoque"] . "</td><td>" . $row["descricao"] . "</td><td>". $row["valor"] . "</td></tr>";
